...
SIGNAL \A15|Output_Mux|Mux0~4_combout\ : std_logic;
...
-- Equation(s):
-- \A0|Output_Mux|Mux0~2_combout\ = (\b~combout\(0) & ((\control~combout\(1) & ((!\control~combout\(0)) # (!\control~combout\(2)))) # (!\control~combout\(1) & ((\control~combout\(0)))))) # (!\b~combout\(0) & (\control~combout\(2) & (!\control~combout\(1))))
...
-- pragma translate_on
PORT MAP (
	datab => \A0|Output_Mux|Mux0~2_combout\,
...
PORT MAP (
	dataa => \b~combout\(0),
	datab => \A0|Adder_1bit|cout~0_combout\,
	datac => \control~combout\(1),
	datad => \control~combout\(0),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \C0|Mux0~0_combout\ = ((\control~combout\(2) & (\control~combout\(0)))) # (!\control~combout\(1))
...
-- Equation(s):
-- \A1|Output_Mux|Mux0~0_combout\ = (\C0|Mux0~0_combout\ & (((\C0|Mux1~0_combout\)))) # (!\C0|Mux0~0_combout\ & (\A0|Adder_1bit|cout~1_combout\ & ((!\C0|Mux1~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \A0|Adder_1bit|cout~1_combout\,
...
-- Equation(s):
-- \A1|Adder_1bit|sum~0_combout\ = (\a~combout\(1) $ (((\control~combout\(2) & !\control~combout\(1)))))
...
-- Equation(s):
-- \A1|mulB|Xout~0_combout\ = \b~combout\(1) $ (((\control~combout\(2) & ((!\control~combout\(1)))) # (!\control~combout\(2) & (\control~combout\(0) & \control~combout\(1)))))
...
-- Equation(s):
-- \A1|Output_Mux|Mux0~1_combout\ = (\C0|Mux0~0_combout\ & ((\A1|Output_Mux|Mux0~0_combout\ & ((\A1|Adder_1bit|sum~0_combout\) # (\A1|mulB|Xout~0_combout\))) # (!\A1|Output_Mux|Mux0~0_combout\ & (\A1|Adder_1bit|sum~0_combout\ & \A1|mulB|Xout~0_combout\)))) # 
-- (!\C0|Mux0~0_combout\ & (\A1|Output_Mux|Mux0~0_combout\ $ (\A1|Adder_1bit|sum~0_combout\ $ (\A1|mulB|Xout~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \A1|Output_Mux|Mux0~0_combout\,
	datab => \A1|Adder_1bit|sum~0_combout\,
	datac => \A1|mulB|Xout~0_combout\,
...
-- Equation(s):
-- \A1|Adder_1bit|cout~0_combout\ = (\A1|Adder_1bit|sum~0_combout\ & ((\A0|Adder_1bit|cout~1_combout\) # (\b~combout\(1) $ (\C0|Mux3~0_combout\)))) # (!\A1|Adder_1bit|sum~0_combout\ & (\A0|Adder_1bit|cout~1_combout\ & (\b~combout\(1) $ 
-- (\C0|Mux3~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \A1|Adder_1bit|cout~0_combout\,
	datab => \C0|Mux0~0_combout\,
	datad => \C0|Mux1~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A2|mulB|Xout~0_combout\ = \b~combout\(2) $ (((\control~combout\(1) & (!\control~combout\(2) & \control~combout\(0))) # (!\control~combout\(1) & (\control~combout\(2)))))
...
-- Equation(s):
-- \A2|Adder_1bit|sum~0_combout\ = \a~combout\(2) $ (((!\control~combout\(1) & ((\control~combout\(2))))))
...
-- Equation(s):
-- \A2|Output_Mux|Mux0~1_combout\ = (\C0|Mux0~0_combout\ & ((\A2|Output_Mux|Mux0~0_combout\ & ((\A2|mulB|Xout~0_combout\) # (\A2|Adder_1bit|sum~0_combout\))) # (!\A2|Output_Mux|Mux0~0_combout\ & (\A2|mulB|Xout~0_combout\ & \A2|Adder_1bit|sum~0_combout\)))) # 
-- (!\C0|Mux0~0_combout\ & (\A2|Output_Mux|Mux0~0_combout\ $ (\A2|mulB|Xout~0_combout\ $ (\A2|Adder_1bit|sum~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \A2|Output_Mux|Mux0~0_combout\,
	datab => \A2|mulB|Xout~0_combout\,
	datac => \A2|Adder_1bit|sum~0_combout\,
	datad => \C0|Mux0~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A2|Adder_1bit|cout~0_combout\ = (\A2|Adder_1bit|sum~0_combout\ & ((\A1|Adder_1bit|cout~0_combout\) # (\C0|Mux3~0_combout\ $ (\b~combout\(2))))) # (!\A2|Adder_1bit|sum~0_combout\ & (\A1|Adder_1bit|cout~0_combout\ & (\C0|Mux3~0_combout\ $ 
-- (\b~combout\(2)))))
...
PORT MAP (
	...
	datab => \A2|Adder_1bit|sum~0_combout\,
	datac => \b~combout\(2),
...
-- Equation(s):
-- \A3|Output_Mux|Mux0~0_combout\ = ((\C0|Mux1~0_combout\ & ((\C0|Mux0~0_combout\))) # (!\C0|Mux1~0_combout\ & (\A2|Adder_1bit|cout~0_combout\ & !\C0|Mux0~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \A2|Adder_1bit|cout~0_combout\,
...
-- Equation(s):
-- \A3|Output_Mux|Mux0~1_combout\ = (\C0|Mux0~0_combout\ & ((\A3|mulB|Xout~0_combout\ & ((\A3|Adder_1bit|sum~0_combout\) # (\A3|Output_Mux|Mux0~0_combout\))) # (!\A3|mulB|Xout~0_combout\ & (\A3|Adder_1bit|sum~0_combout\ & \A3|Output_Mux|Mux0~0_combout\)))) # 
-- (!\C0|Mux0~0_combout\ & (\A3|mulB|Xout~0_combout\ $ (\A3|Adder_1bit|sum~0_combout\ $ (\A3|Output_Mux|Mux0~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \A3|mulB|Xout~0_combout\,
	datab => \A3|Adder_1bit|sum~0_combout\,
	datac => \A3|Output_Mux|Mux0~0_combout\,
	datad => \C0|Mux0~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A4|Output_Mux|Mux0~0_combout\ = ((\C0|Mux0~0_combout\ & ((\C0|Mux1~0_combout\))) # (!\C0|Mux0~0_combout\ & (\A3|Adder_1bit|cout~0_combout\ & !\C0|Mux1~0_combout\)))
...
-- Equation(s):
-- \A4|mulB|Xout~0_combout\ = \b~combout\(4) $ (((\control~combout\(1) & (\control~combout\(0) & !\control~combout\(2))) # (!\control~combout\(1) & ((\control~combout\(2))))))
...
-- Equation(s):
-- \A4|Output_Mux|Mux0~1_combout\ = (\C0|Mux0~0_combout\ & ((\A4|Adder_1bit|sum~0_combout\ & ((\A4|Output_Mux|Mux0~0_combout\) # (\A4|mulB|Xout~0_combout\))) # (!\A4|Adder_1bit|sum~0_combout\ & (\A4|Output_Mux|Mux0~0_combout\ & \A4|mulB|Xout~0_combout\)))) # 
-- (!\C0|Mux0~0_combout\ & (\A4|Adder_1bit|sum~0_combout\ $ (\A4|Output_Mux|Mux0~0_combout\ $ (\A4|mulB|Xout~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \A4|Adder_1bit|sum~0_combout\,
	datab => \A4|Output_Mux|Mux0~0_combout\,
	datac => \C0|Mux0~0_combout\,
	datad => \A4|mulB|Xout~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A4|Adder_1bit|cout~0_combout\ = (\A4|Adder_1bit|sum~0_combout\ & ((\A3|Adder_1bit|cout~0_combout\) # (\C0|Mux3~0_combout\ $ (\b~combout\(4))))) # (!\A4|Adder_1bit|sum~0_combout\ & (\A3|Adder_1bit|cout~0_combout\ & (\C0|Mux3~0_combout\ $ 
-- (\b~combout\(4)))))
...
-- Equation(s):
-- \A5|Output_Mux|Mux0~0_combout\ = ((\C0|Mux1~0_combout\ & (\C0|Mux0~0_combout\)) # (!\C0|Mux1~0_combout\ & (!\C0|Mux0~0_combout\ & \A4|Adder_1bit|cout~0_combout\)))
...
PORT MAP (
	...
	datac => \C0|Mux0~0_combout\,
	datad => \A4|Adder_1bit|cout~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A5|Adder_1bit|sum~0_combout\ = (\a~combout\(5) $ (((\control~combout\(2) & !\control~combout\(1)))))
...
-- Equation(s):
-- \A5|mulB|Xout~0_combout\ = \b~combout\(5) $ (((\control~combout\(2) & ((!\control~combout\(1)))) # (!\control~combout\(2) & (\control~combout\(0) & \control~combout\(1)))))
...
-- Equation(s):
-- \A5|Output_Mux|Mux0~1_combout\ = (\C0|Mux0~0_combout\ & ((\A5|Output_Mux|Mux0~0_combout\ & ((\A5|Adder_1bit|sum~0_combout\) # (\A5|mulB|Xout~0_combout\))) # (!\A5|Output_Mux|Mux0~0_combout\ & (\A5|Adder_1bit|sum~0_combout\ & \A5|mulB|Xout~0_combout\)))) # 
-- (!\C0|Mux0~0_combout\ & (\A5|Output_Mux|Mux0~0_combout\ $ (\A5|Adder_1bit|sum~0_combout\ $ (\A5|mulB|Xout~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \A5|Output_Mux|Mux0~0_combout\,
	datab => \A5|Adder_1bit|sum~0_combout\,
	datac => \C0|Mux0~0_combout\,
	datad => \A5|mulB|Xout~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A6|mulB|Xout~0_combout\ = \b~combout\(6) $ (((\control~combout\(1) & (\control~combout\(0) & !\control~combout\(2))) # (!\control~combout\(1) & ((\control~combout\(2))))))
...
-- Equation(s):
-- \A5|Adder_1bit|cout~0_combout\ = (\A4|Adder_1bit|cout~0_combout\ & ((\A5|Adder_1bit|sum~0_combout\) # (\b~combout\(5) $ (\C0|Mux3~0_combout\)))) # (!\A4|Adder_1bit|cout~0_combout\ & (\A5|Adder_1bit|sum~0_combout\ & (\b~combout\(5) $ 
-- (\C0|Mux3~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \A4|Adder_1bit|cout~0_combout\,
	datab => \b~combout\(5),
	datac => \C0|Mux3~0_combout\,
...
-- Equation(s):
-- \A6|Output_Mux|Mux0~0_combout\ = ((\C0|Mux1~0_combout\ & ((\C0|Mux0~0_combout\))) # (!\C0|Mux1~0_combout\ & (\A5|Adder_1bit|cout~0_combout\ & !\C0|Mux0~0_combout\)))
...
-- Equation(s):
-- \A6|Output_Mux|Mux0~1_combout\ = (\C0|Mux0~0_combout\ & ((\A6|Adder_1bit|sum~0_combout\ & ((\A6|mulB|Xout~0_combout\) # (\A6|Output_Mux|Mux0~0_combout\))) # (!\A6|Adder_1bit|sum~0_combout\ & (\A6|mulB|Xout~0_combout\ & \A6|Output_Mux|Mux0~0_combout\)))) # 
-- (!\C0|Mux0~0_combout\ & (\A6|Adder_1bit|sum~0_combout\ $ (\A6|mulB|Xout~0_combout\ $ (\A6|Output_Mux|Mux0~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \A6|Adder_1bit|sum~0_combout\,
	datab => \A6|mulB|Xout~0_combout\,
	datac => \A6|Output_Mux|Mux0~0_combout\,
	datad => \C0|Mux0~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A7|mulB|Xout~0_combout\ = \b~combout\(7) $ (((\control~combout\(2) & (!\control~combout\(1))) # (!\control~combout\(2) & (\control~combout\(1) & \control~combout\(0)))))
...
-- Equation(s):
-- \A6|Adder_1bit|cout~0_combout\ = (\A6|Adder_1bit|sum~0_combout\ & ((\A5|Adder_1bit|cout~0_combout\) # (\b~combout\(6) $ (\C0|Mux3~0_combout\)))) # (!\A6|Adder_1bit|sum~0_combout\ & (\A5|Adder_1bit|cout~0_combout\ & (\b~combout\(6) $ 
-- (\C0|Mux3~0_combout\))))
...
PORT MAP (
	...
	datac => \C0|Mux3~0_combout\,
	datad => \A5|Adder_1bit|cout~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A7|Output_Mux|Mux0~0_combout\ = (\C0|Mux1~0_combout\ & (((\C0|Mux0~0_combout\)))) # (!\C0|Mux1~0_combout\ & (\A6|Adder_1bit|cout~0_combout\ & ((!\C0|Mux0~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \A6|Adder_1bit|cout~0_combout\,
	datab => \C0|Mux1~0_combout\,
	datad => \C0|Mux0~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A7|Output_Mux|Mux0~1_combout\ = (\C0|Mux0~0_combout\ & ((\A7|mulB|Xout~0_combout\ & ((\A7|Adder_1bit|sum~0_combout\) # (\A7|Output_Mux|Mux0~0_combout\))) # (!\A7|mulB|Xout~0_combout\ & (\A7|Adder_1bit|sum~0_combout\ & \A7|Output_Mux|Mux0~0_combout\)))) # 
-- (!\C0|Mux0~0_combout\ & (\A7|mulB|Xout~0_combout\ $ (\A7|Adder_1bit|sum~0_combout\ $ (\A7|Output_Mux|Mux0~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \A7|mulB|Xout~0_combout\,
	datab => \A7|Adder_1bit|sum~0_combout\,
	datac => \A7|Output_Mux|Mux0~0_combout\,
	datad => \C0|Mux0~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A8|Adder_1bit|sum~0_combout\ = \a~combout\(8) $ ((((\control~combout\(2) & !\control~combout\(1)))))
...
-- Equation(s):
-- \A8|Output_Mux|Mux0~0_combout\ = ((\C0|Mux1~0_combout\ & ((\C0|Mux0~0_combout\))) # (!\C0|Mux1~0_combout\ & (\A7|Adder_1bit|cout~0_combout\ & !\C0|Mux0~0_combout\)))
...
-- Equation(s):
-- \A8|Output_Mux|Mux0~1_combout\ = (\C0|Mux0~0_combout\ & ((\A8|Adder_1bit|sum~0_combout\ & ((\A8|mulB|Xout~0_combout\) # (\A8|Output_Mux|Mux0~0_combout\))) # (!\A8|Adder_1bit|sum~0_combout\ & (\A8|mulB|Xout~0_combout\ & \A8|Output_Mux|Mux0~0_combout\)))) # 
-- (!\C0|Mux0~0_combout\ & (\A8|Adder_1bit|sum~0_combout\ $ (\A8|mulB|Xout~0_combout\ $ (\A8|Output_Mux|Mux0~0_combout\))))
...
PORT MAP (
	...
	datab => \A8|mulB|Xout~0_combout\,
	datac => \A8|Output_Mux|Mux0~0_combout\,
	datad => \C0|Mux0~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A9|Adder_1bit|sum~0_combout\ = \a~combout\(9) $ (((\control~combout\(2) & ((!\control~combout\(1))))))
...
-- Equation(s):
-- \A8|Adder_1bit|cout~0_combout\ = (\A7|Adder_1bit|cout~0_combout\ & ((\A8|Adder_1bit|sum~0_combout\) # (\C0|Mux3~0_combout\ $ (\b~combout\(8))))) # (!\A7|Adder_1bit|cout~0_combout\ & (\A8|Adder_1bit|sum~0_combout\ & (\C0|Mux3~0_combout\ $ 
-- (\b~combout\(8)))))
...
-- Equation(s):
-- \A9|Output_Mux|Mux0~0_combout\ = (\C0|Mux0~0_combout\ & (((\C0|Mux1~0_combout\)))) # (!\C0|Mux0~0_combout\ & (((\A8|Adder_1bit|cout~0_combout\ & !\C0|Mux1~0_combout\))))
...
PORT MAP (
	...
	datac => \A8|Adder_1bit|cout~0_combout\,
	datad => \C0|Mux1~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A9|mulB|Xout~0_combout\ = \b~combout\(9) $ (((\control~combout\(2) & ((!\control~combout\(1)))) # (!\control~combout\(2) & (\control~combout\(0) & \control~combout\(1)))))
...
-- Equation(s):
-- \A9|Output_Mux|Mux0~1_combout\ = (\C0|Mux0~0_combout\ & ((\A9|Adder_1bit|sum~0_combout\ & ((\A9|Output_Mux|Mux0~0_combout\) # (\A9|mulB|Xout~0_combout\))) # (!\A9|Adder_1bit|sum~0_combout\ & (\A9|Output_Mux|Mux0~0_combout\ & \A9|mulB|Xout~0_combout\)))) # 
-- (!\C0|Mux0~0_combout\ & (\A9|Adder_1bit|sum~0_combout\ $ (\A9|Output_Mux|Mux0~0_combout\ $ (\A9|mulB|Xout~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \A9|Adder_1bit|sum~0_combout\,
...
-- Equation(s):
-- \A9|Adder_1bit|cout~0_combout\ = (\A8|Adder_1bit|cout~0_combout\ & ((\A9|Adder_1bit|sum~0_combout\) # (\b~combout\(9) $ (\C0|Mux3~0_combout\)))) # (!\A8|Adder_1bit|cout~0_combout\ & (\A9|Adder_1bit|sum~0_combout\ & (\b~combout\(9) $ 
-- (\C0|Mux3~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \A8|Adder_1bit|cout~0_combout\,
	datab => \b~combout\(9),
	datac => \C0|Mux3~0_combout\,
...
-- pragma translate_on
PORT MAP (
	datab => \A9|Adder_1bit|cout~0_combout\,
	datac => \C0|Mux0~0_combout\,
	datad => \C0|Mux1~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A10|Adder_1bit|sum~0_combout\ = (\a~combout\(10) $ (((\control~combout\(2) & !\control~combout\(1)))))
...
-- Equation(s):
-- \A10|Output_Mux|Mux0~1_combout\ = (\C0|Mux0~0_combout\ & ((\A10|mulB|Xout~0_combout\ & ((\A10|Output_Mux|Mux0~0_combout\) # (\A10|Adder_1bit|sum~0_combout\))) # (!\A10|mulB|Xout~0_combout\ & (\A10|Output_Mux|Mux0~0_combout\ & 
-- \A10|Adder_1bit|sum~0_combout\)))) # (!\C0|Mux0~0_combout\ & (\A10|mulB|Xout~0_combout\ $ (\A10|Output_Mux|Mux0~0_combout\ $ (\A10|Adder_1bit|sum~0_combout\))))
...
-- Equation(s):
-- \A10|Adder_1bit|cout~0_combout\ = (\A9|Adder_1bit|cout~0_combout\ & ((\A10|Adder_1bit|sum~0_combout\) # (\b~combout\(10) $ (\C0|Mux3~0_combout\)))) # (!\A9|Adder_1bit|cout~0_combout\ & (\A10|Adder_1bit|sum~0_combout\ & (\b~combout\(10) $ 
-- (\C0|Mux3~0_combout\))))
...
-- Equation(s):
-- \A11|Output_Mux|Mux0~0_combout\ = ((\C0|Mux1~0_combout\ & ((\C0|Mux0~0_combout\))) # (!\C0|Mux1~0_combout\ & (\A10|Adder_1bit|cout~0_combout\ & !\C0|Mux0~0_combout\)))
...
-- Equation(s):
-- \A11|mulB|Xout~0_combout\ = \b~combout\(11) $ (((\control~combout\(2) & ((!\control~combout\(1)))) # (!\control~combout\(2) & (\control~combout\(0) & \control~combout\(1)))))
...
-- Equation(s):
-- \A11|Output_Mux|Mux0~1_combout\ = (\C0|Mux0~0_combout\ & ((\A11|Output_Mux|Mux0~0_combout\ & ((\A11|mulB|Xout~0_combout\) # (\A11|Adder_1bit|sum~0_combout\))) # (!\A11|Output_Mux|Mux0~0_combout\ & (\A11|mulB|Xout~0_combout\ & 
-- \A11|Adder_1bit|sum~0_combout\)))) # (!\C0|Mux0~0_combout\ & (\A11|Output_Mux|Mux0~0_combout\ $ (\A11|mulB|Xout~0_combout\ $ (\A11|Adder_1bit|sum~0_combout\))))
...
-- Equation(s):
-- \A11|Adder_1bit|cout~0_combout\ = (\A10|Adder_1bit|cout~0_combout\ & ((\A11|Adder_1bit|sum~0_combout\) # (\b~combout\(11) $ (\C0|Mux3~0_combout\)))) # (!\A10|Adder_1bit|cout~0_combout\ & (\A11|Adder_1bit|sum~0_combout\ & (\b~combout\(11) $ 
-- (\C0|Mux3~0_combout\))))
...
-- Equation(s):
-- \A12|Output_Mux|Mux0~0_combout\ = (\C0|Mux0~0_combout\ & (((\C0|Mux1~0_combout\)))) # (!\C0|Mux0~0_combout\ & (((!\C0|Mux1~0_combout\ & \A11|Adder_1bit|cout~0_combout\))))
...
PORT MAP (
	dataa => \C0|Mux0~0_combout\,
	datac => \C0|Mux1~0_combout\,
	datad => \A11|Adder_1bit|cout~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A12|mulB|Xout~0_combout\ = \b~combout\(12) $ (((\control~combout\(1) & (\control~combout\(0) & !\control~combout\(2))) # (!\control~combout\(1) & ((\control~combout\(2))))))
...
-- Equation(s):
-- \A12|Adder_1bit|sum~0_combout\ = (\a~combout\(12) $ (((\control~combout\(2) & !\control~combout\(1)))))
...
-- Equation(s):
-- \A12|Output_Mux|Mux0~1_combout\ = (\C0|Mux0~0_combout\ & ((\A12|Output_Mux|Mux0~0_combout\ & ((\A12|mulB|Xout~0_combout\) # (\A12|Adder_1bit|sum~0_combout\))) # (!\A12|Output_Mux|Mux0~0_combout\ & (\A12|mulB|Xout~0_combout\ & 
-- \A12|Adder_1bit|sum~0_combout\)))) # (!\C0|Mux0~0_combout\ & (\A12|Output_Mux|Mux0~0_combout\ $ (\A12|mulB|Xout~0_combout\ $ (\A12|Adder_1bit|sum~0_combout\))))
...
PORT MAP (
	dataa => \C0|Mux0~0_combout\,
	datab => \A12|Output_Mux|Mux0~0_combout\,
	datac => \A12|mulB|Xout~0_combout\,
	datad => \A12|Adder_1bit|sum~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A12|Adder_1bit|cout~0_combout\ = (\A12|Adder_1bit|sum~0_combout\ & ((\A11|Adder_1bit|cout~0_combout\) # (\b~combout\(12) $ (\C0|Mux3~0_combout\)))) # (!\A12|Adder_1bit|sum~0_combout\ & (\A11|Adder_1bit|cout~0_combout\ & (\b~combout\(12) $ 
-- (\C0|Mux3~0_combout\))))
...
-- Equation(s):
-- \A13|Output_Mux|Mux0~0_combout\ = ((\C0|Mux0~0_combout\ & ((\C0|Mux1~0_combout\))) # (!\C0|Mux0~0_combout\ & (\A12|Adder_1bit|cout~0_combout\ & !\C0|Mux1~0_combout\)))
...
-- Equation(s):
-- \A13|Output_Mux|Mux0~1_combout\ = (\C0|Mux0~0_combout\ & ((\A13|Adder_1bit|sum~0_combout\ & ((\A13|mulB|Xout~0_combout\) # (\A13|Output_Mux|Mux0~0_combout\))) # (!\A13|Adder_1bit|sum~0_combout\ & (\A13|mulB|Xout~0_combout\ & 
-- \A13|Output_Mux|Mux0~0_combout\)))) # (!\C0|Mux0~0_combout\ & (\A13|Adder_1bit|sum~0_combout\ $ (\A13|mulB|Xout~0_combout\ $ (\A13|Output_Mux|Mux0~0_combout\))))
...
-- Equation(s):
-- \A14|mulB|Xout~0_combout\ = \b~combout\(14) $ (((\control~combout\(2) & (!\control~combout\(1))) # (!\control~combout\(2) & (\control~combout\(1) & \control~combout\(0)))))
...
-- Equation(s):
-- \A13|Adder_1bit|cout~0_combout\ = (\A12|Adder_1bit|cout~0_combout\ & ((\A13|Adder_1bit|sum~0_combout\) # (\b~combout\(13) $ (\C0|Mux3~0_combout\)))) # (!\A12|Adder_1bit|cout~0_combout\ & (\A13|Adder_1bit|sum~0_combout\ & (\b~combout\(13) $ 
-- (\C0|Mux3~0_combout\))))
...
-- Equation(s):
-- \A14|Output_Mux|Mux0~0_combout\ = ((\C0|Mux1~0_combout\ & (\C0|Mux0~0_combout\)) # (!\C0|Mux1~0_combout\ & (!\C0|Mux0~0_combout\ & \A13|Adder_1bit|cout~0_combout\)))
...
-- Equation(s):
-- \A14|Output_Mux|Mux0~1_combout\ = (\C0|Mux0~0_combout\ & ((\A14|Adder_1bit|sum~0_combout\ & ((\A14|mulB|Xout~0_combout\) # (\A14|Output_Mux|Mux0~0_combout\))) # (!\A14|Adder_1bit|sum~0_combout\ & (\A14|mulB|Xout~0_combout\ & 
-- \A14|Output_Mux|Mux0~0_combout\)))) # (!\C0|Mux0~0_combout\ & (\A14|Adder_1bit|sum~0_combout\ $ (\A14|mulB|Xout~0_combout\ $ (\A14|Output_Mux|Mux0~0_combout\))))
...
PORT MAP (
	...
	datab => \A14|mulB|Xout~0_combout\,
	datac => \C0|Mux0~0_combout\,
	datad => \A14|Output_Mux|Mux0~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A15|Output_Mux|Mux0~0_combout\ = (\control~combout\(1) & (!\control~combout\(2) & (\control~combout\(0)))) # (!\control~combout\(1) & (\control~combout\(2)))
...
-- Equation(s):
-- \A15|Output_Mux|Mux0~2_combout\ = (\A15|Output_Mux|Mux0~0_combout\ & (!\b~combout\(15) & (\control~combout\(1) $ (!\a~combout\(15))))) # (!\A15|Output_Mux|Mux0~0_combout\ & (\b~combout\(15) & ((\a~combout\(15)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \A15|Output_Mux|Mux0~0_combout\,
	datab => \b~combout\(15),
	datac => \control~combout\(1),
	datad => \a~combout\(15),
	devclrn => ww_devclrn,
...
-- Equation(s):
-- \A15|Output_Mux|Mux0~1_combout\ = \b~combout\(15) $ (\a~combout\(15) $ (((\A15|Output_Mux|Mux0~0_combout\ & \control~combout\(1)))))
...
PORT MAP (
	...
	datac => \b~combout\(14),
	datad => \A14|Adder_1bit|sum~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A15|Output_Mux|Mux0~3_combout\ = (\C0|Mux0~0_combout\ & (((\C0|Mux1~0_combout\)))) # (!\C0|Mux0~0_combout\ & (((\A14|Adder_1bit|cout~0_combout\ & !\C0|Mux1~0_combout\))))
...
PORT MAP (
	dataa => \C0|Mux0~0_combout\,
	datac => \A14|Adder_1bit|cout~0_combout\,
	datad => \C0|Mux1~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\A15|Output_Mux|Mux0~4\ : maxv_lcell
-- Equation(s):
-- \A15|Output_Mux|Mux0~4_combout\ = (\C0|Mux0~0_combout\ & ((\A15|Output_Mux|Mux0~2_combout\ & (!\A15|Output_Mux|Mux0~1_combout\)) # (!\A15|Output_Mux|Mux0~2_combout\ & (\A15|Output_Mux|Mux0~1_combout\ & \A15|Output_Mux|Mux0~3_combout\)))) # 
-- (!\C0|Mux0~0_combout\ & (\A15|Output_Mux|Mux0~3_combout\ $ (((!\A15|Output_Mux|Mux0~2_combout\ & \A15|Output_Mux|Mux0~1_combout\)))))
...
PORT MAP (
	...
	datac => \A15|Output_Mux|Mux0~1_combout\,
	datad => \A15|Output_Mux|Mux0~3_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \A15|Output_Mux|Mux0~4_combout\);
...
-- pragma translate_on
PORT MAP (
	datain => \A15|Output_Mux|Mux0~4_combout\,
	oe => VCC,
	padio => ww_res(15));
